    ...
    <li>
        ...
        <span class="app-menu__label">Clientes</span></a></li>
        <?php } ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a class="treeview-item" href="<?= base_url(); ?>/productos">
                            <i class="icon fa fa-circle-o"></i> Productos</a></li>
                    <?php } ?>
                    <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                    <li>
                        <a class="treeview-item" href="<?= base_url(); ?>/categorias">
                            <i class="icon fa fa-circle-o"></i>Categorias</a></li>
                    <?php } ?>
                </ul>
            </li>
        <?php } ?>
    ...
    <li>
        ...
        <i class="app-menu__icon  fa fa-window-close" aria-hidden="true"></i>
